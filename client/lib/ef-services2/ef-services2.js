  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "User";
        ...
        /**
         * @ngdoc method
         * @name lbServices.User#employe
         * @methodOf lbServices.User
         *
         * @description
         *
         * Fetches belongsTo relation employe
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         */
        R.employe = function() {
          var TargetResource = $injector.get("Employe");
          var action = TargetResource["::get::user::employe"];
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Employe";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Employe#merchant
         * @methodOf lbServices.Employe
         *
         * @description
         *
        ...
        R.merchant = function() {
          var TargetResource = $injector.get("Merchant");
          var action = TargetResource["::get::employe::merchant"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#create
         * @methodOf lbServices.Point
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#findById
         * @methodOf lbServices.Point
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#updateAll
         * @methodOf lbServices.Point
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#deleteById
         * @methodOf lbServices.Point
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#prototype$updateAttributes
         * @methodOf lbServices.Point
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#updateOrCreate
         * @methodOf lbServices.Point
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#destroyById
         * @methodOf lbServices.Point
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Point#removeById
         * @methodOf lbServices.Point
         *
         * @description
         *
    ...
    */
    R.modelName = "Point";
        ...
        R.agent = function() {
          var TargetResource = $injector.get("Employe");
          var action = TargetResource["::get::point::agent"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Bill#updateAll
         * @methodOf lbServices.Bill
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Bill#prototype$updateAttributes
         * @methodOf lbServices.Bill
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Bill#updateOrCreate
         * @methodOf lbServices.Bill
         *
         * @description
         *
    ...
    */
    R.modelName = "Bill";
        ...
        R.merchant = function() {
          var TargetResource = $injector.get("Merchant");
          var action = TargetResource["::get::bill::merchant"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Bill#shop
         * @methodOf lbServices.Bill
         *
         * @description
         *
        ...
        R.shop = function() {
          var TargetResource = $injector.get("Shop");
          var action = TargetResource["::get::bill::shop"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Bill#agent
         * @methodOf lbServices.Bill
         *
         * @description
         *
        ...
        R.agent = function() {
          var TargetResource = $injector.get("Employe");
          var action = TargetResource["::get::bill::agent"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Return
 * @header lbServices.Return
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Return` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#create
         * @methodOf lbServices.Return
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Return` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/returns",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#findById
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#findOne
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#updateAll
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#deleteById
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#prototype$updateAttributes
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#updateOrCreate
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#destroyById
         * @methodOf lbServices.Return
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Return#removeById
         * @methodOf lbServices.Return
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Return#modelName
    * @propertyOf lbServices.Return
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Return`.
    */
